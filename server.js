...
app.post('/resume/evaluate', async (req, res) => {

    runPythonScript(req.body.prompt)
    .then(result => {
    ...
    //     let response =  await parser.invoke(result);
...
function runPythonScript(prompt) {
    return new Promise((resolve, reject) => {
        ...
        const pythonProcess = spawn('python', ['AI_reseum_evaluator.py',prompt]);
